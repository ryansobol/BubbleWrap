...
describe BW::UIActionSheet do
  ...
  describe ".black_translucent" do
    describe "given no options" do
      before do
        @subject = BW::UIActionSheet.black_translucent
      end

      behaves_like "an instance with no options"

      it "has the correct style" do
        @subject.style.should.equal(UIActionSheetStyleBlackTranslucent)
      end
    ...
    describe "given no options with a block" do
      before do
        @options = {}
        @block   = -> { true }
        @subject = BW::UIActionSheet.black_translucent(@options, &@block)
      end
  ...
  describe ".black_opaque" do
    describe "given no options" do
      before do
        @subject = BW::UIActionSheet.black_opaque
      end

      behaves_like "an instance with no options"

      it "has the correct style" do
        @subject.style.should.equal(UIActionSheetStyleBlackOpaque)
      end
    ...
    describe "given no options with a block" do
      before do
        @options = {}
        @block   = -> { true }
        @subject = BW::UIActionSheet.black_opaque(@options, &@block)
      end
